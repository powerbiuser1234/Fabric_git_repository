...
def scd1_merge(source_table, target_table, primary_key):
    ...
    merge_condition = f"target.{primary_key} = source.{primary_key} AND target.HireDate = source.HireDate"
...
# ## **Applying SCD1 on Target Table "GoldLakehouse.CbsClientPrfDim"**

# CELL ********************

# Run the function for your table
scd1_merge("SilverLakehouse.CbsClientPrfDim", "GoldLakehouse.CbsClientPrfDim", "ClientCode")
