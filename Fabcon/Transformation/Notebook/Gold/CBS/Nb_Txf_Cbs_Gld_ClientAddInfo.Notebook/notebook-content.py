...
def scd1_merge(source_table, target_table, primary_key):
    ...
    merge_condition = f"target.{primary_key} = source.{primary_key} AND target.DataIdentifierCode = source.DataIdentifierCode AND target.DataValue = source.DataValue"
...
# ## Applying SCD1 on Target Table "GoldLakehouse.CbsClientAddInfo

# CELL ********************

# Run the function for your table
scd1_merge("SilverLakehouse.CbsClientAddInfo", "GoldLakehouse.CbsClientAddInfo", "ClientCode")
