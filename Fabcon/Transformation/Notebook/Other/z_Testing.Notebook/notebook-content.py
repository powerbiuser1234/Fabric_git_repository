...
# CBS Table creation (34 tables)

# CELL ********************

df = spark.sql("SELECT * FROM BronzeLakehouse.Cbs_Bkmetier LIMIT 1000")
display(df)
...
df = spark.sql("SELECT * FROM BronzeLakehouse.Cbs_Bkprod LIMIT 1000")
display(df)
...
df = spark.sql("SELECT * FROM BronzeLakehouse.Cbs_Bksmetier LIMIT 1000")
display(df)
